...
" k system stuff
syn keyword kSystemFunction _log _exp _abs _sqr _sqrt _floor _dot _mul _inv _sin _cos _tan _asin _acos _atan _sinh _cosh _tanh _lsq _draw _jd _dj _ltime _lt _gtime _in _bin _lin _binl _dv _dvl _di _dil _sv _vs _ci _ic _sm _ss _ssr _bd _db _getenv _setenv _host _size _exit
